//
//  ChristmasTableViewController.swift
//  PresentBase
//
...
class ChristmasTableViewController: UITableViewController {

    let myGifts = [["name": "Best Friend", "image": "dragon", "item": "Camera"], ["name": "Last Friend", "image": "car", "item": "Pendrive"], ["name": "Ultimate Friend", "image": "car", "item": "Sugar"]]
    
    override func viewDidLoad() {
        super.viewDidLoad()

        let iconImageView = UIImageView(image: UIImage(named: "dragon"))
